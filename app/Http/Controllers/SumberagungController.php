...
class SumberagungController extends Controller
{
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<div class="btn-group">
                                <a class="btn btn-info" href="' . route('edit-sumberagung', $row->id) . '" role="button"><i class="bi bi-info-circle"></i></a>
                                <a class="btn btn-primary" href="' . route('export-sumberagung', $row->id) . '" role="button"><i class="bi bi-file-earmark-word"></i></a>
    ...
    {
        return view('sumberagung.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = Sumberagung::find($request->No_Nominatif);
        if ($data) {
            $data->delete();
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Sumberagung $k1)
    {
        //
    }
    ...
    public function edit($No_Nominatif)
    {
        ...
        return view('sumberagung.edit', compact(['data']));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Sumberagung $k1)
    {
    }
