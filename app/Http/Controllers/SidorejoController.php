...
class SidorejoController extends Controller
{
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return '<div class="btn-group">
                                <a class="btn btn-info" target="_blank" href="' . route('edit-sidorejo', $row->id) . '" role="button"><i class="bi bi-info-circle"></i></a>
                                <a class="btn btn-primary" href="' . route('export-sidorejo', $row->id) . '" role="button"><i class="bi bi-file-earmark-word"></i></a>
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('create-sidorejo')->with($notif, $message);
        } catch (Throwable $e) {
            DB::rollback();
            $notif = "error";
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Sidorejo $k1)
    {
        //
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Sidorejo $k1)
    {
    }
    ...
    {
        return view('sidorejo.updatebpn');
    }
    ...
    public function updatebpn(Request $request)
    {
        ...
        try {
            ...
            $notif = "message";
            $message = "No Nominatif " . $request->No_Nominatif . " berhasil disimpan";
            return redirect()->route('showupdatebpn_sidorejo')->with($notif, $message);
        } catch (Throwable $e) {
            DB::rollback();
            $notif = "error";
            $message = sprintf('[%s]', json_encode($e->getMessage(), true));
