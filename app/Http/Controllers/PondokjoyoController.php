...
class PondokjoyoController extends Controller
{
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    return $btn = '<a class="btn btn-primary" href="' . route('edit-pondokjoyo', $row->id) . '" role="button"><i class="bi bi-folder"></i></a>
                                    <a class="btn btn-danger delete-btn" href="' . route('destroy-pondokjoyo', $row->id) . '" role="button"><i class="bi-trash3"></i></a>';
                })
                ->rawColumns(['action'])
                ->make(true);
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Pondokjoyo $k1)
    {
        //
    }
    ...
    public function edit($No_Nominatif)
    {
        ...
        return view('pondokjoyo.edit', compact(['data']));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Pondokjoyo $k1)
    {
    }
