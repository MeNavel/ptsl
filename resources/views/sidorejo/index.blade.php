            ...
            <div class="col-lg-12 mt-60">
                <div class="container-fluid card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="/sidorejo/create">Tambah Data</a>
                        <a class="btn btn-primary" href="{{ route('showupdatebpn_sidorejo') }}">Update Data BPN</a>
                        <a class="btn btn-primary" href="/downloadsidorejo">Download Excel</a>
                        <a class="btn btn-primary" href="/downloadsidorejokoordinator">Data Setiap Koordinator</a>
                        <br><br>
                        <!-- Small tables -->
