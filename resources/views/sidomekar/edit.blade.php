        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="container-fluid card">
                    <div class="card-body">
                        <h5 class="card-title">Edit Pendaftaran K1 Desa Sidomekar</h5>
                        <form action="/sidomekar">
                            <button type="submit" class="btn btn-primary">Home</button>
                        </form>
                        <br>
                        <!-- Data teknis tanah -->
                        <form action="/sidomekar/store" method="POST" class="row g-3">
                            @csrf
                            <div class="col-md-3">
                            ...
                            <div class="col-3">
                                ...
                                <input type="text" name="PBT" class="form-control" id="PBT" value="{{$data->PBT}}">
                            </div>
                            <div class="col-3">
                                <label for="No_Berkas" class="form-label">No Berkas</label>
                                <input type="text" name="No_Berkas" class="form-control" id="No_Berkas" value="{{$data->No_Berkas}}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-3">
                                <label for="NUB" class="form-label">Nomor Pengumuman</label>
                                <input type="text" name="NUB" class="form-control" id="NUB" value="{{$data->NUB}}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-3">
                                <label for="NIB" class="form-label">NIB</label>
                                <input type="text" name="NIB" class="form-control" id="NIB" value="{{$data->NIB}}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-2">
                                <label for="Luas_Ukur" class="form-label">Luas Ukur</label>
                                <input type="number" name="Luas_Ukur" class="form-control" id="Luas_Ukur" value="{{$data->Luas_Ukur}}"
                                    oninput=calculate()>
                            </div>

                            <div class="col-1">
                                <label for="Beda_Luas" class="form-label">Beda Luas</label>
                                <input type="text" name="Beda_Luas" class="form-control" id="Beda_Luas" readonly value="{{$data->Selisih_Luas}}">
                            </div>

                            {{-- Data diri pemohon --}}
                            <div class="col-6">
                                <label for="No_KTP_NIK" class="form-label">NIK</label>
                                <input type="text" name="No_KTP_NIK" placeholder="Pemohon Pengajuan Sertifikat" value="{{$data->No_KTP_NIK}}"
                            ...
                            <div class="col-2">
                                ...
                                <input type="date" onchange="age()" name="Tanggal_Lahir" class="form-control" value="{{$data->Tanggal_Lahir}}"
                                    id="Tanggal_Lahir">
                            </div>
                            <div class="col-1">
                                <label for="Usia" class="form-label">Usia</label>
                                <input type="text" name="Usia" class="form-control" id="Usia" readonly value="{{$data->Usia}}">
                            </div>
                            <div class="col-3">
                                <label for="Alamat_Pemilik" class="form-label">Alamat Pemilik</label>
                                <input type="text" name="Alamat_Pemilik" class="form-control" id="Alamat_Pemilik" value="{{$data->Alamat_Pemilik}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-6 an_sertifikat">
                                ...
                                <input type="text" name="An_No_KTP_NIK" placeholder="Atas Nama Sertifikat" value="{{$data->An_No_KTP_NIK}}"
                                    class="form-control" id="An_No_KTP_NIK">
                            </div>
                            <div class="col-6 an_sertifikat">
                                <label for="An_Nama" class="form-label">Nama</label>
                                <input type="text" name="An_Nama" class="form-control" id="An_Nama" value="{{$data->An_Nama}}">
                            </div>
                            <div class="col-2 an_sertifikat">
                                <label for="An_Tempat_Lahir" class="form-label">Tempat Lahir</label>
                                <input type="text" name="An_Tempat_Lahir" class="form-control" id="An_Tempat_Lahir" value="{{$data->An_Tempat_Lahir}}">
                            </div>
                            <div class="col-2 an_sertifikat">
                                <label for="An_Tanggal_Lahir" class="form-label">Tanggal Lahir</label>
                                <input type="date" onchange="an_age()" name="An_Tanggal_Lahir" class="form-control" value="{{$data->An_Tanggal_Lahir}}"
                                    id="An_Tanggal_Lahir">
                            </div>
                            <div class="col-1 an_sertifikat">
                                <label for="An_Usia" class="form-label">Usia</label>
                                <input type="text" name="An_Usia" class="form-control" id="An_Usia" readonly value="{{$data->An_Usia}}">
                            </div>
                            <div class="col-7 an_sertifikat">
                                <label for="An_Alamat_Pemilik" class="form-label">Alamat Pemilik</label>
                                <input type="text" name="An_Alamat_Pemilik" class="form-control" value="{{$data->An_Alamat_Pemilik}}"
                            ...
                            <div class="col-1">
                                ...
                                <input type="text" name="RT_Letak_Tanah" class="form-control" id="RT_Letak_Tanah" value="{{$data->RT_Letak_Tanah}}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-1">
                                <label for="RW_Letak_Tanah" class="form-label">RW</label>
                                <input type="text" name="RW_Letak_Tanah" class="form-control" id="RW_Letak_Tanah" value="{{$data->RW_Letak_Tanah}}"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <input type="text" name="No_C" class="form-control" id="No_C" value="{{$data->No_C}}">
                            </div>
                            <div class="col-2">
                                <label for="No_Persil" class="form-label">Nomor Persil</label>
                                <input type="text" name="No_Persil" class="form-control" id="No_Persil" value="{{$data->No_Persil}}">
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                ...
                                <input oninput=calculate() type="number" name="Luas_Permohonan" class="form-control" value="{{$data->Luas_Permohonan}}"
                                    id="Luas_Permohonan">
                            </div>
                            <div class="col-2">
                                <label for="Batas_Utara" class="form-label">Batas Utara</label>
                                <input type="text" name="Batas_Utara" class="form-control" id="Batas_Utara" value="{{$data->Batas_Utara}}">
                            </div>
                            <div class="col-2">
                                <label for="Batas_Timur" class="form-label">Batas Timur</label>
                                <input type="text" name="Batas_Timur" class="form-control" id="Batas_Timur" value="{{$data->Batas_Timur}}">
                            </div>
                            <div class="col-2">
                                <label for="Batas_Selatan" class="form-label">Batas Selatan</label>
                                <input type="text" name="Batas_Selatan" class="form-control" id="Batas_Selatan" value="{{$data->Batas_Selatan}}">
                            </div>
                            <div class="col-2">
                                <label for="Batas_Barat" class="form-label">Batas Barat</label>
                                <input type="text" name="Batas_Barat" class="form-control" id="Batas_Barat" value="{{$data->Batas_Barat}}">
                            </div>
                            ...
                            <div class="col-2">
                                ...
                                <input type="text" name="Tahun_Peralihan_1" class="form-control" value="{{$data->Tahun_Peralihan_1}}"
                                    id="Tahun_Peralihan_1"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-10">
                                <label for="Peralihan_1_Kepada" class="form-label">Nama 1</label>
                                <input type="text" name="Peralihan_1_Kepada" class="form-control" value="{{$data->Peralihan_1_Kepada}}"
                                    id="Peralihan_1_Kepada">
                            </div>
                            <div class="col-2">
                                <label for="Tahun_Peralihan_2" class="form-label">Tahun 2</label>
                                <input type="text" name="Tahun_Peralihan_2" class="form-control" value="{{$data->Tahun_Peralihan_2}}"
                                    id="Tahun_Peralihan_2"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">
                            </div>
                            <div class="col-10">
                                <label for="Peralihan_2_Kepada" class="form-label">Nama 2</label>
                                <input type="text" name="Peralihan_2_Kepada" class="form-control" value="{{$data->Peralihan_2_Kepada}}"
                            ...
                            <div class="col-10">
                                ...
                                <input type="text" name="Dasar_Peralihan_2" class="form-control" value="{{$data->Dasar_Peralihan_2}}"
                                    id="Dasar_Peralihan_2">
                            </div>
                            <div class="col-2">
                                <label for="Tahun_Perolehan_Terakhir" class="form-label">Tahun 3</label>
                                <input type="text" name="Tahun_Perolehan_Terakhir" class="form-control" value="{{$data->Tahun_Perolehan_Terakhir}}"
                            ...
                            <div class="col-8">
                                ...
                                <input type="text" name="Alas_Hak_Bukti_Perolehan" class="form-control" value="{{$data->Alas_Hak_Bukti_Perolehan}}"
