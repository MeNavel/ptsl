        ...
        <div class="row">
            <div class="col-lg-12 mt-60">
                <div class="container-fluid card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Nominatif Pendaftaran Sertifikat Tanah Desa Sidomulyo</h5>
                        <a class="btn btn-primary" href="/sidomulyo/create">Tambah Data</a>
                        <a class="btn btn-primary" href="{{ route('showupdatebpn_sidomulyo') }}">Update Data BPN</a>
                        <a class="btn btn-primary" href="/downloadsidomulyo">Download Excel</a>
                        <a class="btn btn-primary" href="/downloadsidomulyokoordinator">Data Setiap Koordinator</a>
                        <br><br>
                        <!-- Small tables -->
