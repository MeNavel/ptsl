        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="container-fluid card">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Edit Pendaftaran K1 Desa Sidomulyo</h5>
                        ...
                        <form action="/sidomulyo/store" method="POST" class="row g-3">
                            ...
                            <div class="col-2">
                                ...
                                <select class="form-select" id="Dusun_Letak_Tanah" name="Dusun_Letak_Tanah"
                                    aria-label="State">
                                    <option value="PUCUAN" @selected($data->Dusun_Letak_Tanah == "PUCUAN")>PUCUAN</option>
                                    <option value="ROWOTENGU" @selected($data->Dusun_Letak_Tanah == "ROWOTENGU")>ROWOTENGU</option>
                                </select>
                            </div>
                            <div class="col-2">
